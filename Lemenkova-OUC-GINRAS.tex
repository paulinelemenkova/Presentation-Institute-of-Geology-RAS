...
%	style=phys, 
	maxbibnames=99,
	citestyle=numeric, % citestyle=authoryear,
	giveninits=true,
	isbn=true,
	url=true,
	natbib=true,
	sorting=ndymdt, % Sort by name (descending), year, month (descending), title.
	bibencoding=utf8,
	useprefix=false,
	language=auto, 
	autolang=other,
...
\addbibresource{Scatterplot.bib}
\renewcommand*{\bibfont}{\tiny} %\scriptsize %\footnotesize%\scriptsize%\tiny
